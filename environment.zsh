...
() {
  ...
  local __zshenv_saved_parse_braced_body=${functions[__zshenv_parse_braced_body]-}
  local __zshenv_saved_append_reference=${functions[__zshenv_append_reference]-}
  ...
  integer __zshenv_had_parse_braced_body=${+functions[__zshenv_parse_braced_body]}
  integer __zshenv_had_append_reference=${+functions[__zshenv_append_reference]}
  ...
  function __zshenv_parse_braced_body {
    local __zshenv_body=$1 __zshenv_suffix
  ...
  function __zshenv_append_reference {
    ...
    if (( __zshenv_parameter_set )); then
      ...
      [[ $__zshenv_parameter_type != *array* &&
        $__zshenv_parameter_type != *association* ]] || return 1
      __zshenv_current=${(P)__zshenv_name}
    fi

    if [[ $__zshenv_operator == ':-' ]] &&
      (( ! __zshenv_parameter_set || ! ${#__zshenv_current} )); then
      __zshenv_output+=$__zshenv_fallback
    elif [[ $__zshenv_operator == '-' ]] &&
      (( ! __zshenv_parameter_set )); then
      __zshenv_output+=$__zshenv_fallback
    else
    ...
    if [[ $__zshenv_input == ${~__zshenv_fast_value_pattern} ]]; then
      ...
      while [[ $__zshenv_remaining == *'$'* ]]; do
        ...
        if [[ $__zshenv_remaining[1] == '{' ]]; then
          ...
          __zshenv_parse_braced_body $__zshenv_body || return 1
        else
        ...
        __zshenv_append_reference || return 1
      done
  ...
  if (( __zshenv_had_parse_braced_body )); then
    functions[__zshenv_parse_braced_body]=$__zshenv_saved_parse_braced_body
  else
    unfunction __zshenv_parse_braced_body
  fi
  if (( __zshenv_had_append_reference )); then
    functions[__zshenv_append_reference]=$__zshenv_saved_append_reference
  else
    unfunction __zshenv_append_reference
  fi
